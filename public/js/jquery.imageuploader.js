    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            ...
            var dom = {
                ...
                selectButton: $('<input name="clothes_img" style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple class="js-uploader__file-input uploader__file-input">' +
            ...
            function addItem (file) {
                ...
                var sizeWrapper;
                var fileNameWrapper = $(`<span class="uploader__file-list__text" value="${fileName}" name="clothes_images[]">${fileName}</span>`);

                state.listIndex++;

                var listItem = $('<li class="uploader__file-list__item" data-index="' + id + '"></li>');
                var thumbnailContainer = $('<span class="uploader__file-list__thumbnail">asd</span>');
